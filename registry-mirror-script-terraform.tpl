...
CLUSTER_VERSION=4.12.60

RELEASE_CHANNEL=stable-4.12
...
echo "Adding the public-key to the install-config.yaml"

echo "sshKey: $(cat $homedir/.ssh/authorized_keys)" >> $homedir/cluster/install-config.yaml
